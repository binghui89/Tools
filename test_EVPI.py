    ...
    for stage in scenario_tree._stages:
        ...
        for tree_node in stage._tree_nodes:
            ...
            row = [str(stage_name), 
                    str(tree_node_name), 
                    str(obj), 
                    str(stage_cost_vardata.index()), 
                    str(stage_cost_vardata())]
            if obj not in rows:
                rows[obj] = [row]
            else:
                rows[obj].append(row)
...
def solve_ef(ef_options):
    import os, sys
    sif = ScenarioTreeInstanceFactory(ef_options.model_directory, 
                                        ef_options.instance_directory, 
                                        ef_options.verbose
                                        )
    ...
    sys.stdout = sys.__stdout__; f.close(); 
...
#     import sys
#     sys.stderr.write('\nSolving European Farmer problem\n')
#     sys.stderr.write('-'*25 + '\n')
#     p_model = '/home/bli/TEMOA/Stochastic/Farmer/ReferenceModel.py'
#     p_data  = '/home/bli/TEMOA/Stochastic/Farmer/scenariodata'
...
#     sys.stderr.write('-'*25 + '\n')
#     p_model = '/afs/unity.ncsu.edu/users/b/bli6/temoa/temoa_model/temoa_stochastic.py'
...
# def NCstochatic(p_model, p_data):
#     from time import time
#     import sys
#     sys.stderr.write('\nSolving temoa problem: NC\n')
#     sys.stdout.write('-'*25 + '\n')
...
#     sys.stderr.write('-'*25 + '\n')
#     p_model = '/afs/unity.ncsu.edu/users/b/bli6/temoa/temoa_model/temoa_stochastic.py'
#     p_data  = '/afs/unity.ncsu.edu/users/b/bli6/TEMOA_stochastic/utopia_demand'
#     sys.stderr.write('\nSolving perfect sight mode\n')
#     pf_result = solve_pf(p_model, p_data)
#     ef_args = ['-m', p_model, '-i', p_data, '--solver', 'cplex', '--solve']
#     ef_option_parser = construct_ef_writer_options_parser('runef [options]')
#     start_time = time()
#     (ef_options, args) = ef_option_parser.parse_args(args=ef_args)
#     sys.stderr.write('\nSolving extensive form\n')
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        # European farmer problem from Birge and Louveaux, 1997
        # p_model = '/afs/unity.ncsu.edu/users/b/bli6/TEMOA_stochastic/Farmer/ReferenceModel.py'
        # p_data = '/afs/unity.ncsu.edu/users/b/bli6/TEMOA_stochastic/Farmer/scenariodata'

        # USND
        # p_model = '/afs/unity.ncsu.edu/users/b/bli6/temoa/temoa_model/temoa_stochastic.py'
        # p_data = '/afs/unity.ncsu.edu/users/b/bli6/TEMOA_stochastic/USND'
        ...
        # NC case
        p_model = '/afs/unity.ncsu.edu/users/b/bli6/temoa/temoa_model/temoa_stochastic.py'
        p_data  = '/afs/unity.ncsu.edu/users/b/bli6/TEMOA_stochastic/NC'
    else:
        p_model = sys.argv[1]
        p_data = sys.argv[2]
